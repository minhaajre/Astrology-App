...
ENTITY A (${personA.name})
  ...
  Destiny Code (DC): ${result.A.DC ?? "N/A"}
  Identity Code Latin (IC-L): ${result.A.ICL ?? "N/A"}
  Essence Code Arabic (EC-A): ${result.A.ECA ? `${result.A.ECA.sum} (reduced: ${result.A.ECA.reduced}, mod9: ${result.A.ECA.mod9}, ${result.A.ECA.intensity} intensity)` : "N/A"}
...
ENTITY B (${entityBName}) - ${entityBType === "place" ? "Place" : "Person"}
  ...
  Destiny Code (DC): ${result.B.DC ?? "N/A"}
  Identity Code Latin (IC-L): ${result.B.ICL ?? "N/A"}
  Essence Code Arabic (EC-A): ${result.B.ECA ? `${result.B.ECA.sum} (reduced: ${result.B.ECA.reduced}, mod9: ${result.B.ECA.mod9}, ${result.B.ECA.intensity} intensity)` : "N/A"}
...
`;
    ...
    const axisLabels: Record<string, string> = {
      A1_LatinCore: "Latin Core",
      A2_ArabicCore: "Arabic Core",
      A3_Destiny: "Trajectory",
      A4_LatinAdaptAB: "Latin Adapt A->B",
      A5_LatinAdaptBA: "Latin Adapt B->A",
      A6_ArabicAdaptAB: "Arabic Adapt A->B",
      A7_ArabicAdaptBA: "Arabic Adapt B->A",
    };
