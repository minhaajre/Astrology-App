        ...
        <>
          ...
          <Card className="border-blue-200/50 bg-blue-50/30 dark:border-blue-900/30 dark:bg-blue-950/20 mb-6">
            ...
            <CardContent className="text-sm text-blue-800 dark:text-blue-300 space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-xs">
                <li><strong>Latin Core:</strong> How your Latin names align</li>
                <li><strong>Arabic Core:</strong> How your Arabic names align</li>
                <li><strong>Trajectory:</strong> How your birth dates align</li>
                <li><strong>4 Adaptation Axes:</strong> How each person adapts to the other's Latin and Arabic signatures</li>
              </ul>
              <p className="mt-2">The mode (Reinforcement, Growth, etc.) and tension index reveal dynamic patterns between the three code layers.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Time and behavior pattern derived from when you were born
              </p>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Public name signature using Pythagorean letter-to-number mapping (A=1, B=2... Z=26)
              </p>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Spiritual letter-weight signature using classical Abjad numeral system (ا=1, ب=2... ي=10, etc.)
              </p>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2">
