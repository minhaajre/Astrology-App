  ...
  return (
    <div className="space-y-6">
      <Card>
        ...
        <CardContent>
          <div className="rounded-lg bg-muted/50 p-4 text-sm text-muted-foreground border border-muted mb-6">
            <p>
      ...
      <Accordion type="single" collapsible className="space-y-2">
        {sortedCategories.map((category) => (
          ...
          >
            <AccordionTrigger className="px-6 py-4 hover:no-underline" data-testid={`category-${category}`}>
